export const profile = {
  ...
  email: "vishalkrsoni1@gmail.com",
  phone: "+91-7838516299",
  resume: "/Vishal-resume.pdf",
  ...
  metrics: [
    ...
    { value: "80%", label: "Performance gains delivered in critical APIs" },
    { value: "3", label: "Microservices owned end to end recently" },
  ...
  socials: [
    ...
    {
      label: "Bitbucket",
      href: "https://bitbucket.org/vishalkrsoni1/workspace/overview/",
    },
  ],
};
