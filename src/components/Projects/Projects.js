...
export default function Projects() {
  const groups = useMemo(() => ["Client / Enterprise Work", "Personal Work"], []);
    ...
    <>
      <section className={styles.section} id="projects">
        <div className={styles.headingWrap}>
          <SectionHeading align="center" eyebrow="Selected Work" title="Projects" />
          <p>
            Production systems, client platforms, and independent builds with the technical
        ...
        <div className={styles.grid}>
          {visibleProjects.map((project) => {
            const hasDetails = project.highlights?.length || project.responsibilities?.length;
      ...
      {selectedProject
        ? createPortal(
            ...
            >
              <article className={styles.modal} role="dialog" aria-modal="true" aria-labelledby="project-detail-title">
                ...
                <div className={styles.modalFooter}>
                  ...
                  {selectedProject.href ? (
                    <a className={styles.textLink} href={selectedProject.href} target="_blank" rel="noreferrer">
                      View Project
                      <ExternalLink size={17} />
                    </a>
                  ) : null}
